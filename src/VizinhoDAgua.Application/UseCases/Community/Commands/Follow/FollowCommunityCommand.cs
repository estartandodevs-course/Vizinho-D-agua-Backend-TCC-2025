...
{
    public class FollowCommunityCommand : IRequestWithValidation<Unit>
    {
        public Guid CommunityId { get; private set; }
        public Guid UserId { get; private set; }
        public ValidationResult ValidationResult { get; private set; } = null!;

        public FollowCommunityCommand(Guid communityId, Guid userId)
        {
        ...
        {
            var validations = new InlineValidator<FollowCommunityCommand>();
